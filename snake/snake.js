...
onkeydown = onkeyup = function(e){
    ...
    console.log(map);
    if (map[38] && (snake.direction != 2)) {snake.direction = 0; if (gameMode == 3) {send({'direction': 0})}}
    if (map[39] && (snake.direction != 3)) {snake.direction = 1; if (gameMode == 3) {send({'direction': 1})}}
    if (map[40] && (snake.direction != 0)) {snake.direction = 2; if (gameMode == 3) {send({'direction': 2})}}
    if (map[37] && (snake.direction != 1)) {snake.direction = 3; if (gameMode == 3) {send({'direction': 3})}}
