...
var main = function() {
  ...
  lasers.forEach(function(a, b){ships.forEach(function(c, b) {if (a.x < c.x + c.size && a.x + a.sizeX > c.x && a.y < c.y + c.sizeY && a.sizeY + a.y > c.y) {a.remove(); lasers.splice(b, 1);c.remove(); ships.splice(d, 1);}})});
};
