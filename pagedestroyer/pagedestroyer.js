  ...
  document.body.style.backgroundColor = 'lightgrey';
    ...
    onclick = function(e) {
      ...
      if (tool == 'repair') {
        ...
        (document.getElementById(Math.floor(e.x/blockX+','+Math.floor(e.y/blockY))).parentNode.removeChild(document.getElementById(Math.floor(e.x/blockX+','+Math.floor(e.y/blockY)));
      }
